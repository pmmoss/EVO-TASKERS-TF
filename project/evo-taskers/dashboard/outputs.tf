# Outputs for Dashboard (all environments)
...
output "function_app_id" {
  description = "The ID of the Dashboard Function App"
  value       = module.windows_function_app.id
}

output "function_app_name" {
  description = "The name of the Dashboard Function App"
  value       = module.windows_function_app.name
}

output "function_app_default_hostname" {
  description = "The default hostname of the Dashboard Function App"
  value       = module.windows_function_app.default_hostname
}

output "function_app_identity_principal_id" {
  description = "The principal ID of the Dashboard Function App managed identity"
