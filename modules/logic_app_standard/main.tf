...
# App Service Plan for Logic App Standard (optional - can use external plan)
...
resource "azurerm_logic_app_standard" "this" {
  ...
  location                   = var.location
  resource_group_name        = var.resource_group_name
  app_service_plan_id        = var.create_service_plan ? azurerm_service_plan.this[0].id : var.existing_service_plan_id
